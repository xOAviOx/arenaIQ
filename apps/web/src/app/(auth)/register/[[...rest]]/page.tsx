  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-12">
      ...
      <div className="stagger mb-8 text-center" style={{ ['--i' as string]: 1 }}>
        <BrandMark size="lg" />
        <p className="mt-4 font-display text-2xl font-bold text-arena-text">Claim your spot</p>
        <p className="mt-1 text-sm text-arena-dim">Start at 1200. Climb from there.</p>
      </div>
